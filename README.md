...
- The setup intent menu now includes **Installed Build publish/pull sync** so double-click users can run the same artifact rollout flow without leaving the main wizard path.
